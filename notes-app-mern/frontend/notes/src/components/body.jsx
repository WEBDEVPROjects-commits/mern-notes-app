    ...
    <>
      <div className="min-h-screen bg-slate-50 px-6 py-8">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {Notes.map((note) => {
            return (
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition duration-300 p-6 flex flex-col justify-between" key={note._id}>
                <div>
        ...
        <button
          className="fixed bottom-8 right-8 w-16 h-16 rounded-full bg-indigo-600 hover:bg-indigo-700 shadow-xl flex items-center justify-center text-white transition duration-300"
          onClick={(e) => {
